...
else if (passwordLength < 8, passwordLength !== 0, passwordLength.indexOf(" ") < 0, passwordLength !== "", passwordLength !== null || passwordLength > 128, passwordLength !== 0, passwordLength.indexOf(" ") < 0, passwordLength !== "", passwordLength !== null ) {
  console.log(passwordLength);
