...
if (passwordLength === "" || passwordLength === null || passwordLength === undefined) {
  window.prompt("Please enter a value between 8 and 128 (inclusive)")
}
...
else if (passwordLength < 8 && !null || passwordLength > 128 && !null)
