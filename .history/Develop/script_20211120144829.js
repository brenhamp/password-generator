...
if (passwordLength >= 8 && passwordLength <= 128 && passwordLength instanceof (" ") == true || passwordLength.indexOf (" ") < 0){
...
else if (passwordLength instanceof (" ") == true || passwordLength.indexOf (" ") >= 0) {
...
else if (passwordLength < 8, passwordLength !== "", passwordLength !== null || passwordLength > 128, passwordLength !== "", passwordLength !== null ) {
  console.log(passwordLength);
