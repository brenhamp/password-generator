...
passwordText = function() {
  ...
  if (!lowercaseConfirm) {
    allowedChars= "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890 !”“#$%&'()*+-./:;<=>?@[\\]^_`{|}~".replace("abcdefghijklmnopqrstuvwxyz", "");
  ...
  if (!numberConfirm) {
    allowedChars= "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890 !”“#$%&'()*+-./:;<=>?@[\\]^_`{|}~".replace("1234567890", "");


  if (!specialConfirm) {
    allowedChars= "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890 !”“#$%&'()*+-./:;<=>?@[\\]^_`{|}~".replace(" !”“#$%&'()*+-./:;<=>?@[\\]^_`{|}~", "");
  };
}
  }
}
