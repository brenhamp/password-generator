...
passwordText = function() {
  ...
  if (lowercaseChar == true, uppercaseChar == true, numberChar == true, specialChar == true) {
     generatePassword = lowercaseChar[Math.floor(Math.random()*passwordLength)] + uppercaseChar[Math.floor(Math.random()*passwordLength)];
     JSON.stringify(generatePassword);
