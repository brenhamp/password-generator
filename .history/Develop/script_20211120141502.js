...
else if (passwordLength < 8, passwordLength !== 0, passwordLength.string.includes(" ") == false, passwordLength !== null || passwordLength > 128, passwordLength !== 0, passwordLength.string.includes(" ") == false, passwordLength !== null ) {
  console.log(passwordLength);
