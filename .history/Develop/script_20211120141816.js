...
else if (passwordLength < 8, passwordLength !== 0, passwordLength.indexOf(" ") == false, passwordLength !== null || passwordLength > 128, passwordLength !== 0, passwordLength.indexOf(" ") == false, passwordLength !== null ) {
  console.log(passwordLength);
...
else if (passwordLength.includes (" ") == true) {
