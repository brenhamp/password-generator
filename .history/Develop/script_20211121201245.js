...
//all 4 character types
  ...
  allowedChars.concat(lowercaseChars, uppercaseChars, numberChars, specialChars)
}

//3 character types

else if (lowercaseConfirm && uppercaseConfirm && numberConfirm && !specialConfirm) {
  allowedChars.concat(lowercaseChars, uppercaseChars, numberChars)
}

else if (lowercaseConfirm && uppercaseConfirm && !numberConfirm && specialConfirm) {
  allowedChars.concat(lowercaseChars, uppercaseChars, specialChars)
}

else if (lowercaseConfirm && !uppercaseConfirm && numberConfirm && specialConfirm) {
  allowedChars.concat(lowercaseChars, numberChars, specialChars)
}

else if (!lowercaseConfirm && uppercaseConfirm && numberConfirm && specialConfirm) {
  allowedChars.concat(uppercaseChars, numberChars, specialChars)
}

//2 character types

else if (lowercaseConfirm && uppercaseConfirm && !numberConfirm && !specialConfirm) {
  allowedChars.concat(lowercaseChars, uppercaseChars)
}

else if (lowercaseConfirm && !uppercaseConfirm && numberConfirm && !specialConfirm) {
  allowedChars.concat(lowercaseChars, numberChars)
}

else if (!lowercaseConfirm && uppercaseConfirm && numberConfirm && !specialConfirm) {
  allowedChars.concat(uppercaseChars, numberChars)
}

else if (lowercaseConfirm && !uppercaseConfirm && !numberConfirm && specialConfirm) {
  allowedChars.concat(lowercaseChars, specialChars)
}

else if (!lowercaseConfirm && uppercaseConfirm && !numberConfirm && specialConfirm) {
  allowedChars.concat(uppercaseChars, specialChars)
}

else if (!lowercaseConfirm && !uppercaseConfirm && numberConfirm && specialConfirm) {
  allowedChars.concat(numberChars, specialChars)
}

//1 character type

else if (lowercaseConfirm && !uppercaseConfirm && !numberConfirm && !specialConfirm) {
  allowedChars.concat(lowercaseChars)
}

else if (!lowercaseConfirm && uppercaseConfirm && !numberConfirm && !specialConfirm) {
  allowedChars.concat(uppercaseChars)
}

else if (!lowercaseConfirm && !uppercaseConfirm && numberConfirm && !specialConfirm) {
  allowedChars.concat(numberChars)
}

else {
  allowedChars.concat(specialChars)
}
