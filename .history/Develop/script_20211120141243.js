...
//if input is blank or invalid, inform user and return them to the first prompt
else if (passwordLength < 8, passwordLength !== 0, passwordLength.includes(" ") == false, passwordLength !== null || passwordLength > 128, passwordLength !== 0, passwordLength.includes(" ") == false, passwordLength !== null ) {
  console.log(passwordLength);
